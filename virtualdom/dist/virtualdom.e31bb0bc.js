...
function render(element, parentNode) {
  ...
  if (type.isReactComponent) {
    var returnElement = new type(props).render();
    type = returnElement.type;
    props = returnElement.props;
  } else if (typeof type === 'function') {
    var _returnElement = type(props);

    type = _returnElement.type;
    props = _returnElement.props;
  }
...
var _reactDom = _interopRequireDefault(require("./react-dom.js"));
...
function (_React$Component) {
  ...
  function Welcome1() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Welcome1).apply(this, arguments));
  }
  ...
  _createClass(Welcome1, [{
    ...
    value: function render() {
      return _react.default.createElement('h1', {
        id: 'welcome'
      }, this.props.name, this.props.age, this.props.children);
    }
  }]);
...
var element1 = _react.default.createElement(Welcome, {
  name: 'marvin',
  age: 26
});

var element = _react.default.createElement(Welcome1, {
  name: 'hello world',
  age: 100
}, element1);

_reactDom.default.render(element, document.getElementById('root'));
},{"./react-dom.js":"react-dom.js","./react":"react.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/virtualdom.e31bb0bc.js.map